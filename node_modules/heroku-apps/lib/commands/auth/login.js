...
const cmd = {
  ...
  flags: [{ name: 'sso', description: 'login for enterprise users under SSO' }, { name: 'expires-in', char: 'e', description: 'duration of token in seconds', hasValue: true }],
  run: cli.command(co.wrap(run))
};

module.exports = [Object.assign({ topic: 'auth', command: 'login' }, cmd), Object.assign({ topic: 'login' }, cmd)];